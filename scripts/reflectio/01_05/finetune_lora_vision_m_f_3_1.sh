...
# 动态生成运行名
RUN_NAME="run_$(date +%Y%m%d_%H%M%S)_m_f_3_1"  # 当前时间生成唯一运行名
...
# 定义数据集根路径
DATASET_ROOT="/net/papilio/storage7/tingyuan/llama/bias/vlm_bias/sft_dataset/race_gender/bias_m_f_3_1/"
